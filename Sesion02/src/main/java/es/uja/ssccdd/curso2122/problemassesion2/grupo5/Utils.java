...
public class Utils {
    ...
    public static final int TIEMPO_ESPERA_MAX = 5;
    public static final int TIEMPO_ESPERA_MIN = 2;
    public static final int COCHES_A_GENERAR_MIN = 10;
    public static final int COCHES_A_GENERAR_MAX = 25;
